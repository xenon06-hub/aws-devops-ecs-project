...
resource "aws_subnet" "public" {
  ...
  availability_zone       = element(["eu-north-1a", "eu-north-1c"], count.index)
...
# ECS tasks SG - only ALB can talk to ECS
...
resource "aws_ecs_service" "app_service" {
  ...
  lifecycle {
    ignore_changes = [task_definition] # so GitHub Actions can force new deployments
  }
